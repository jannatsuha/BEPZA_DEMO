...
class AppConstant{
  // API BASE URL
  static const String BASE_URL = 'http://erp1.bepza.gov.bd:84';
  static const String TOKOEN_URI = '/api/Jwt';
  static const String ZONE_URI = '/api/PrmZoneInfoes';
  static const String EMPLOYEE_URI = '/api/PrmEmploymentInfoes/';
 ...
 // static const String CONFIG_URI = '/api/v1/config';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: 'Images.united_kindom',
        languageName: 'English', countryCode: 'US', languageCode: 'en'),
    LanguageModel(imageUrl: 'Images.arabic',
